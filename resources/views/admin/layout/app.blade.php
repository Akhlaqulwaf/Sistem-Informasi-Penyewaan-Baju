    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="index.html"><img src="{{ asset('adminassets') }}/assets/images/logo1.svg" alt="logo" /></a>
          <a class="navbar-brand brand-logo-mini" href="index.html"><img src="{{ asset('adminassets') }}/assets/images/test-mini.svg" alt="logo" /></a>
        </div>
            ...
            <li class="nav-item nav-profile dropdown">
              <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                ...
                <div class="nav-profile-text">
                  <p class="mb-1 text-black">Admin NanaSalon</p>
                </div>
              </a>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            <li class="nav-item nav-profile">
              <a href="#" class="nav-link">
                ...
                <div class="nav-profile-text d-flex flex-column">
                  <span class="font-weight-bold mb-2">NanaSalon</span>
            ...
            <li class="nav-item ">
              <a class="nav-link">
              <span class="menu-title" style="color:black">Peminjaman Baju</span>
                <i class="mdi mdi mdi-tshirt-crew menu-icon"></i>
              </a>
            </li>
            ...
            <li class="nav-item ">
              ...
              <div class="collapse" id="ui-basic">
                ...
                <li class="nav-item"> <a class="nav-link" href="{{ route('admin.transaksi.dipinjam') }}">Daftar Pinjam</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{ route('admin.transaksi.denda') }}">Denda</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{ route('admin.transaksi.selesai') }}">Daftar Kembali</a></li>
            ...
            <li class="nav-item ">
              <a class="nav-link">
              <span class="menu-title" style="color:black">Jasa</span>
            ...
            <li class="nav-item ">
              ...
              <div class="collapse" id="ui-basic3">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="{{ route('admin.jasa') }}">Produk</a></li>
                  <li class="nav-item"> <a class="nav-link {{ Request::path() === 'admin/kelompoks' ? 'active' : '' }}" href="{{ route('admin.kelompoks') }}">Kategori</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item ">
              ...
              <div class="collapse" id="ui-basic5">
                <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{ route('admin.trans') }}">Pesanan Baru</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{ route('admin.trans.perludicek') }}">Perlu Di Cek</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{ route('admin.trans.selesai') }}">Selesai</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{ route('admin.trans.dibatalkan') }}">Dibatalkan</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item ">
              ...
              <div class="collapse" id="ui-basic4">
                <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{ route('admin.pengaturan.alamat') }}"> Alamat</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{ route('admin.bon') }}">No Rekening</a></li>
                </ul>
              </div>
            </li>
          </ul>
